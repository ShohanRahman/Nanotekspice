//
// C4094.cpp for  in /home/avelin_j/Work/cpp_nanotekspice/lib
//
// Made by avelin_j
// Login   <avelin_j@epitech.net>
//
// Started on  Sun Feb 21 15:30:14 2016 avelin_j
// Last update Sun Feb 21 15:32:11 2016 avelin_j
//
...
nts::C4094::~C4094(void)
{
}

nts::Tristate nts::C4094::Compute(size_t pin)
{
...
void nts::C4094::SetLink(size_t pin_num_this,
...
{
  std::cout << "Chipset 4094" << std::endl;
  for (int i = 0 ; i < 14 ; i++)
    {
      std::cout << "\tpin #" << i + 1 << ": ";
      if (_pin[i])
...
nts::Tristate nts::C4094::compute_nand(nts::Tristate lhs, nts::Tristate rhs) const
{
...
nts::Tristate nts::C4094::computeInput(size_t pin) const
{
  if (_pin[pin - 1])
    {
...
nts::Tristate nts::C4094::computeOutput(size_t pin) const
{
...
nts::Tristate nts::C4094::computeVDD(size_t pin) const
{
  (void)pin;
...
nts::Tristate nts::C4094::computeVSS(size_t pin) const
{
  (void)pin;
