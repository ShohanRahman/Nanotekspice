//
// C4013.cpp for  in /home/avelin_j/work/cpp_nanotekspice/lib/src/component
// 
// Made by Jordan Aveline
// Login   <avelin_j@epitech.net>
// 
// Started on  Thu Feb 18 11:19:45 2016 Jordan Aveline
// Last update Thu Feb 18 12:22:25 2016 Jordan Aveline
//
...
void nts::C4013::SetLink(size_t pin_num_this,
...
nts::Tristate nts::C4013::compute_nand(nts::Tristate lhs, nts::Tristate rhs) const
{
...
nts::Tristate nts::C4013::computeInput(size_t pin) const
{
  if (_pin[pin - 1])
    {
...
nts::Tristate nts::C4013::computeOutput(size_t pin) const
{
...
nts::Tristate nts::C4013::computeVDD(size_t pin) const
{
  (void)pin;
...
nts::Tristate nts::C4013::computeVSS(size_t pin) const
{
  (void)pin;
