...
// Last update Sun Feb 21 14:59:20 2016 avelin_j
//
...
void nts::C4017::SetLink(size_t pin_num_this,
...
nts::Tristate nts::C4017::compute_nand(nts::Tristate lhs, nts::Tristate rhs) const
{
...
nts::Tristate nts::C4017::computeInput(size_t pin) const
{
  if (_pin[pin - 1])
    {
...
nts::Tristate nts::C4017::computeOutput(size_t pin) const
{
...
nts::Tristate nts::C4017::computeVDD(size_t pin) const
{
  (void)pin;
...
nts::Tristate nts::C4017::computeVSS(size_t pin) const
{
  (void)pin;
